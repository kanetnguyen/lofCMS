 ...
 * left: the distance from the leftmost element to the left side of the document
 ...
 * rightIncludeBody: the distance from the leftmost element to the right side of the document
